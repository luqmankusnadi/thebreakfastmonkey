#pragma strict
public class FriesMonster1 extends Monster implements Attackable,Moveable,Freezeable{
	protected var isMove: boolean;
	protected var isFrozen: boolean;
	protected var speed: float = 5f;
	protected var movePattern: Array = ['d','l','r','u'];
	...
	function Move(){
		...
		this.transform.position = Vector3.Slerp(currentPos,nextPos, (startTime) * speed);
